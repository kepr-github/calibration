...
images = glob.glob('./app/img_resized/*.jpg')
...
for filepath in images:
    ...
    print(img)
    cv2.imwrite('./app/img_drawChessboardCorners/' + str(os.path.basename(filepath)), img)
    cv2.waitKey(0)
...
for filepath in images:
    ...
    cv2.imwrite('./app/img_undistort/undistort_' + str(os.path.basename(filepath)), dst)
    cv2.waitKey(0)